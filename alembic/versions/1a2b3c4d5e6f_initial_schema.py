...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "from_warehouse_id != to_warehouse_id", name="ck_stock_transfers_different_warehouses"
        ),
    ...
    op.create_index(
        "ix_audit_logs_resource_type_created_at", "audit_logs", ["resource_type", "created_at"]
    )
